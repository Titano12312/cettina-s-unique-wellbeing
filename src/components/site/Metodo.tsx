...
export function Metodo() {
  ...
  return (
    <section id="metodo" ref={ref} className="relative bg-background" style={{ height: "300vh" }}>
      <div className="sticky top-0 flex h-screen flex-col overflow-hidden bg-ivory">
