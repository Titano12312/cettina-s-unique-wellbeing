...
export function Contatti() {
  return (
    <section id="contatti" className="relative overflow-hidden bg-background py-32 lg:py-44">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <motion.div
            ...
            className="lg:col-span-6"
          >
            <div className="relative h-full min-h-[480px] overflow-hidden rounded-[36px] border border-border shadow-lux">
              <iframe
